...
amd64_CFLAGS="-g -O2 -mtune=generic -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -flto=auto -ffat-lto-objects -fstack-clash-protection -fcf-protection -mharden-sls=all"
